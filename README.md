...
<table style="width: 100%;">
  <tr style="width: 100%;">
    ...
    <td align="center" width="96">
      <div style="background-color: transparent; border: 1px solid white; padding: 6px 13px; font-size: 16px;">
      <img src="./assets/readme/icons/wordpress.png" alt="WordPress Icon" style="width: 65px; height: 65px;" />
  ...
  <tr style="width: 100%;">
    ...
    <td align="center" width="96">
      <div style="background-color: transparent; border: 1px solid white; padding: 6px 13px; font-size: 16px;">
      <img src="./assets/readme/icons/Redux.png" alt="Redux Icon" style="width: 65px; height: 65px;" />
        <p style="padding: 0; margin: 0;">Redux</p>
      </div>
    </td>
    <td align="center" width="96">
      <div style="background-color: transparent; border: 1px solid white; padding: 6px 13px; font-size: 16px;">
      <img src="./assets/readme/icons/react-native.png" alt="React Native Icon" style="width: 65px; height: 65px;" />
    ...
    <td align="center" width="96">
      <div style="background-color: transparent; border: 1px solid white; padding: 6px 13px; font-size: 16px;">
      <img src="./assets/readme/icons/Angular.png" alt="Angular Icon" style="width: 65px; height: 65px;" />
  ...
  <tr style="width: 100%;">
    ...
    <td align="center" width="96">
      <div style="background-color: transparent; border: 1px solid white; padding: 6px 13px; font-size: 16px;">
        <img src="./assets/readme/icons/Postgresql.png" alt="Postgresql Icon" style="width: 65px; height: 65px;" />
        <p style="padding: 0; margin: 0;">Postgresql</p>
      </div>
    </td>
    <td align="center" width="96">
      <div style="background-color: transparent; border: 1px solid white; padding: 6px 13px; font-size: 16px;">
        <img src="./assets/readme/icons/GraphQL.png" alt="GraphQL Icon" style="width: 65px; height: 65px;" />
        <p style="padding: 0; margin: 0;">GraphQL</p>
      </div>
    </td>
    <td align="center" width="96">
      <div style="background-color: transparent; border: 1px solid white; padding: 6px 13px; font-size: 16px;">
        <img src="./assets/readme/icons/express-js.png" alt="Express Icon" style="width: 65px; height: 65px;" />
        <p style="padding: 0; margin: 0;">Express</p>
      </div>
    </td>
    <td align="center" width="96">
      <div style="background-color: transparent; border: 1px solid white; padding: 6px 13px; font-size: 16px;">
        <img src="./assets/readme/icons/MongoDB.png" alt="MongoDB Icon" style="width: 65px; height: 65px;" />
    ...
    <td align="center" width="96">
      <div style="background-color: transparent; border: 1px solid white; padding: 6px 13px; font-size: 16px;">
        <img src="./assets/readme/icons/blockchain.png" alt="BlockChain Icon" style="width: 65px; height: 65px;" />
        <p style="padding: 0; margin: 0;">BlockChain</p>
      </div>
    </td>
    <td align="center" width="96">
      <div style="background-color: transparent; border: 1px solid white; padding: 6px 13px; font-size: 16px;">
        <img src="./assets/readme/icons/web3.png" style="width: 65px; height: 65px;" />
